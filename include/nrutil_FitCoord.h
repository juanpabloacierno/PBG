...
#define LMIN(a,b) (Iminarg1=(a),lminarg2=(b),(lminarg1) < (Iminarg2) ?\
(Iminarg1) : (Iminarg2))
...
void free_Ivector(unsigned long *v, long nl, long nh);
...
double **submatrix(double **a, long oldrl, long oldrh, long oldcl, long oldch,
long newrl, long newcl)
/* point a submatrix [newrl .. ] [newel .. ] to a[oldrl .. oldrh] [oldcl .. oldch] */
{
